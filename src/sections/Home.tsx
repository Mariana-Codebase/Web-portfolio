  ...
  return (
    <div className="animate-in fade-in zoom-in-95 duration-700">
      <div className={`${themeColors.cardBg} border ${themeColors.cardBorder} p-12 md:p-20 rounded-[3rem] transition-all duration-1000`}>
        ...
        <div className="group/name cursor-default inline-block mb-10">
          <h1 className="text-[12vw] lg:text-[7.5rem] font-black leading-[0.85] tracking-tighter italic transition-all duration-500 group-hover/name:text-blue-600">
        ...
        <div className="flex gap-4 mt-12">
          {[
            ...
            <a 
              key={social.id} 
              href={social.href} 
              className={`group relative p-4 ${themeColors.socialBtn} ${social.hoverColor} rounded-2xl transition-all duration-300 block border ${themeColors.cardBorder}`}
            >
              {social.icon}
              <span className={`
